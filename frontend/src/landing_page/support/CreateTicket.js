...
function CreateTicket() {
  return (
    <div className="container">
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className="">
          <i class="fa fa-user-o" aria-hidden="true"></i>  Your InvestEcho Account
        </h4>
        ...
        <br />
        <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>CMR and DP ID</a>
        <br />
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        ...
        <br />
        <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Referral programme</a>
        <br />
      </div>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        ...
        <br />
        <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>National Pension Scheme </a>
        <br />
