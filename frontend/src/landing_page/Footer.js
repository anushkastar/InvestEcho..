  ...
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        <div className="col">
          <img src="media/images/preview.png" style={{ width: "50%" }} />
          <p>
            &copy;2010 - 2024, InvestEcho Broking Ltd.All rights reserved.
        ...
        <div className="col">
          ...
          <a href=" "> InvestEcho.tech</a><br />
          <a href=" "> Press & media</a><br />
          <a href=" "> Products </a><br />
          <a href=" "> Pricing </a><br />
          <a href=" "> InvestEcho cares (CSR) </a><br />
        </div>
        <div className="col">
          <p>Support</p>
             <a href=" ">Contact</a><br />
